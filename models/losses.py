...
# MeanIoUCustom implementation
class MeanIoUCustom(tf.keras.metrics.Metric):
    def __init__(self, num_classes=None, name="mean_iou_custom", **kwargs):
    ...
    def update_state(self, y_true, y_pred, sample_weight=None):
        ...
        self.mean_iou.update_state(y_true, y_pred, sample_weight=sample_weight)
...
def combined_loss(y_true, y_pred):
    # Example: weighted sum of Dice and Crossentropy
    dice = Weighted_BCEnDice_loss(y_true, y_pred)
