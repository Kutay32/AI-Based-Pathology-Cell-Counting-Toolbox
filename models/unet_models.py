"""
UNet models for segmentation and classification tasks.
"""
...
from tensorflow.keras.layers import Multiply, Add, GlobalAveragePooling2D, Dense, Flatten
...
def build_unet_segmentation(input_shape, num_classes, filters=64, dropout=0.1):
    """
    Build a UNet model for segmentation tasks.
    ...
    Returns:
        Compiled UNet segmentation model
    """
...
def build_unet_classification(input_shape, num_classes, filters=64, dropout=0.1):
    """
    Build a UNet-based model for classification tasks.
    ...
    Returns:
        Compiled UNet classification model
    """
    inputs = Input(input_shape)
    ...
    model = Model(inputs, outputs, name="unet_classification")
    return model